...
/**
 * token_arr_len - Gets te length of current op_toks.
 *
 ...
 *
 * Return: If the line only contains delimeters - 1.
 * Otherwise - 0.
 */
int is_empty_line(char *line, char *delims)
{
...
/**
 * get_op_func - Matches an opcode wit its corresponding function.
